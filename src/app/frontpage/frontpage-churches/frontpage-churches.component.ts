...
@Component({
  selector: 'app-frontpage-churches',
  templateUrl: './frontpage-churches.component.html',
  styleUrl: './frontpage-churches.component.css'
})
export class FrontpageChurchesComponent implements OnInit {
